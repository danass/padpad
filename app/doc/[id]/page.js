        ...
        <div className="mb-4 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-2">
          <div className="flex flex-wrap items-center gap-2">
            ...
            <button
              ...
              className="px-3 sm:px-4 py-2 border border-gray-200 rounded-md hover:bg-gray-50 text-xs sm:text-sm font-medium text-gray-700 transition-colors flex items-center gap-1.5"
            >
            ...
            {isPublic ? (
              <div className="flex items-center gap-1 sm:gap-2">
                <button
                  ...
                  className="px-2 sm:px-4 py-2 border border-green-200 bg-green-50 text-green-700 hover:bg-green-100 rounded-md text-xs sm:text-sm font-medium transition-colors flex items-center gap-1 sm:gap-2"
                >
                ...
                <button
                  ...
                  className="px-2 sm:px-4 py-2 border border-gray-200 text-gray-700 hover:bg-gray-50 rounded-md text-xs sm:text-sm font-medium transition-colors flex items-center gap-1.5"
                >
                  <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <button
                ...
                className="px-2 sm:px-4 py-2 border border-gray-200 text-gray-700 hover:bg-gray-50 rounded-md text-xs sm:text-sm font-medium transition-colors flex items-center gap-1 sm:gap-2"
              >
                <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z" />
                </svg>
                <span className="hidden md:inline">Make Public & Copy Link</span>
            ...
            <div className="relative">
              <button 
                ...
                className="px-3 sm:px-4 py-2 border border-gray-200 rounded-md hover:bg-gray-50 text-xs sm:text-sm font-medium text-gray-700 relative z-10 transition-colors flex items-center gap-1.5"
              >
                <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button
              ...
              className="px-3 sm:px-4 py-2 border border-red-200 text-red-600 hover:bg-red-50 rounded-md text-xs sm:text-sm font-medium transition-colors flex items-center gap-1.5"
