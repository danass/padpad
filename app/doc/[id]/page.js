          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            {isPublic ? (
              <div className="flex items-center gap-1 sm:gap-2">
                <button
                  ...
                  className="px-2 py-1.5 border border-green-200 bg-green-50 text-green-700 hover:bg-green-100 rounded-md text-xs font-medium transition-colors flex items-center gap-1"
                ...
                <button
                  ...
                  className="px-2 py-1.5 border border-gray-200 text-gray-700 hover:bg-gray-50 rounded-md text-xs font-medium transition-colors flex items-center gap-1"
                  title="Make Private"
                >
                  <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="relative">
              <button 
                ...
                className="px-2 py-1.5 border border-gray-200 rounded-md hover:bg-gray-50 text-xs font-medium text-gray-700 relative z-10 transition-colors flex items-center gap-1"
                title="Export"
              >
                <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button
              ...
              className="px-2 py-1.5 border border-red-200 text-red-600 hover:bg-red-50 rounded-md text-xs font-medium transition-colors flex items-center gap-1"
