      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-4 md:py-8">
        ...
        <div className="mb-4 md:mb-6 max-w-2xl">
          <button
            ...
            className="w-full flex items-center justify-between px-4 py-2.5 border border-gray-200 rounded-lg text-gray-400 hover:border-gray-300 hover:bg-gray-50 transition-colors"
          >
            <div className="flex items-center gap-3">
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
              </svg>
              <span className="text-sm">{t?.searchDocuments || 'Search documents...'}</span>
            </div>
            <kbd className="hidden md:inline-flex px-2 py-1 text-xs font-medium text-gray-400 bg-gray-100 rounded">
              ⌘K
            </kbd>
          </button>
        </div>
