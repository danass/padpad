...
export async function generateMetadata() {
  ...
  return {
    ...
    other: {
      'og:logo': 'https://www.textpad.cloud/logo.svg',
    },
    twitter: {
  ...
  return (
    <html lang={locale} suppressHydrationWarning>
      <head suppressHydrationWarning>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&family=DM+Sans:ital,opsz,wght@0,9..40,100..1000;1,9..40,100..1000&display=swap" rel="stylesheet" />
        <script
